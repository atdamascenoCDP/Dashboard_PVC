...
with st.container():
  ...
  with tab3:
    ...
    [
        {"INDICADORES": "Quantidade de caminhões que acessam o porto", "CENÁRIO": "Setoriais", "PERÍODO": True,"DESCRIÇÃO":"teste","Mês" :"DEZEMBRO 2023" },
        {"INDICADORES": "Índice de movimentação de contêineres (vazios)", "CENÁRIO": "Setoriais", "PERÍODO": False,"DESCRIÇÃO":"teste", "Mês" :"DEZEMBRO 2023" },
        {"INDICADORES": "Cumprimento da programação de atracação","CENÁRIO": "Setoriais", "PERÍODO": True,"DESCRIÇÃO":"teste", "Mês" :"DEZEMBRO 2023" },
        {"INDICADORES": "Tempo de espera para atracação (dias)","CENÁRIO": "Setoriais", "PERÍODO": True,"DESCRIÇÃO":"teste", "Mês" :"DEZEMBRO 2023" },
        {"INDICADORES": "Cumprimento da programação de atracação","CENÁRIO": "Setoriais" , "PERÍODO": True,"DESCRIÇÃO":"teste", "Mês" :"DEZEMBRO 2023" },
    ]
    )
